...
<ul>
	...
	<li>qBittorrent 4.6.x</li>
	<li>Transmission 2.x</li>
	<li>Transmission 3.0.0</li>
	<li>Transmission 4.0.1</li>
	<li>Transmission 4.0.2</li>
	<li>Transmission 4.0.3</li>
	<li>Transmission 4.0.4</li>
	<li>Transmission 4.0.5</li>
	<li>uTorrent Mac 1.5.x (scheduled for removal)</li>
	<li>uTorrent Mac 1.8.x (scheduled for removal)</li>
	<li>uTorrent 1.8.x (scheduled for removal)</li>
	<li>uTorrent 2.0.4 (scheduled for removal)</li>
	<li>uTorrent 2.1.x (scheduled for removal)</li>
	<li>uTorrent 2.2.x (scheduled for removal)</li>
	<li>Mainline</li>
</ul>
...
<em>Last updated: February 17th, 2024</em>');
